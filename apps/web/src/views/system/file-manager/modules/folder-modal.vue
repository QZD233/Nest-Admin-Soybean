...
import { fetchFileManagerCreateFolder, fetchFileManagerUpdateFolder } from '@/service/api';
...
async function handleSubmit() {
  ...
  try {
    if (modalType.value === 'add') {
      // 创建时不发送 folderId
      const createData: Api.System.FolderOperateParams = {
      ...
      const updateData: Api.System.FolderOperateParams = {
