...
import { fetchTenantCreate, fetchTenantPackageSelectList, fetchTenantUpdate } from '@/service/api';
...
type Model = Partial<Api.System.TenantOperateParams> & {
  username?: string;
  password?: string;
};
  ...
  try {
    if (props.operateType === 'add') {
      ...
      await fetchTenantCreate({
        ...
        accountCount,
        status
      } as Api.System.TenantOperateParams);
