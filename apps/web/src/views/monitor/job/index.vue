...
import { fetchJobFindAll, fetchJobRemove } from '@/service/api';
...
const {
  ...
  columns: () => [
    ...
    },
    {
      ...
      width: 100,
      render(row) {
        return <DictTag value={(row as unknown as Api.Monitor.Job).jobGroup} dictCode="sys_job_group" />;
      }
    },
    {
      key: 'invokeTarget',
    ...
    },
    {
      ...
      width: 80,
      render(row) {
        const typedRow = row as unknown as Api.Monitor.Job;
        return (
          <StatusSwitch
  ...
  <div class="min-h-500px flex-col-stretch gap-12px overflow-hidden lt-sm:overflow-auto">
    ...
    <NCard title="定时任务" :bordered="false" size="small" class="card-wrapper sm:flex-1-hidden">
      ...
      <JobOperateDrawer
        ...
        :row-data="(editingData as Api.Monitor.Job | null)"
