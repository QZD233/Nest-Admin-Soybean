...
const menuOptions = ref<Api.System.MenuTreeNode[]>([]);
...
async function handleSubmit() {
  ...
  try {
    if (props.operateType === 'add') {
      const createData: Api.System.TenantPackageOperateParams = {
        packageName,
        menuIds,
        remark,
        menuCheckStrictly
      ...
      const updateData: Api.System.TenantPackageOperateParams = {
        packageId: packageId!,
        packageName,
        menuIds,
        remark,
