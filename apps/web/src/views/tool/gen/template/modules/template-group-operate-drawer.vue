...
import { fetchTemplateCreateGroup, fetchTemplateUpdateGroup } from '@/service/api';
...
interface Props {
  ...
  /** the edit row data */
  rowData?: Api.Tool.TemplateGroup | null;
}
...
async function handleSubmit() {
  ...
  try {
    if (props.operateType === 'add') {
      const createData: Api.Tool.TemplateGroupOperateParams = {
        name: model.name,
      ...
      const updateData: Api.Tool.TemplateGroupOperateParams = {
        name: model.name,
        description: model.description || undefined,
        isDefault: model.isDefault,
        status: model.status
