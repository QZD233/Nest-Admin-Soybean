...
import { fetchFileManagerGetFolderTree, fetchFileManagerMoveFiles } from '@/service/api';
...
function buildTreeData(folders: Api.System.FileFolderTreeNode[]): TreeOption[] {
