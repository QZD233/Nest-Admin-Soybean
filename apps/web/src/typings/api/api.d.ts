...
declare namespace Api {
  ...
  namespace Auth {
    ...
    /** login params (alias for PwdLoginForm) */
    type LoginParams = PwdLoginForm;

    /** register params (alias for RegisterForm) */
    type RegisterParams = RegisterForm;
    ...
    /** captcha info (alias for CaptchaCode) */
    type CaptchaInfo = CaptchaCode;
