...
import { fetchTenantPackageFindAll, fetchTenantPackageRemove } from '@/service/api';
...
const {
  ...
  columns: () => [
    ...
    },
    {
      ...
      minWidth: 120,
      render: row => {
        const typedRow = row as unknown as Api.System.TenantPackage;
        return (
          <StatusSwitch
...
/** 处理状态切换 */
async function handleStatusChange(row: Api.System.TenantPackage, value: string, callback: (flag: boolean) => void) {
  try {
