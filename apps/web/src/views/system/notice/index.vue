...
import { fetchNoticeFindAll, fetchNoticeRemove } from '@/service/api';
...
const {
  ...
  columns: () => [
    ...
    },
    {
      ...
      render(row) {
        return (
          <DictTag size="small" value={(row as unknown as Api.System.Notice).noticeType} dictCode="sys_notice_type" />
        );
      }
    },
    {
      ...
      render(row) {
        return (
          <DictTag size="small" value={(row as unknown as Api.System.Notice).status} dictCode="sys_normal_disable" />
        );
      }
    },
    {
    ...
    },
    {
      ...
      width: 130,
      render: row => {
        const typedRow = row as unknown as Api.System.Notice;
        const divider = () => {
